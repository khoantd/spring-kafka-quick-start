...
When testing UI (components, pages, layouts, styling, accessibility), read `.agents/skills/ui-ux-pro-max/SKILL.md` before writing test plans or running validation.
